function test_frobenius_norm_real()
%
...
% Modified by H.Kasai on May 21, 2019
    ...
    if calc_sol
        ...
        if 1
            ...
            options.alg = 'hals';
            [w_sol, infos_sol] = als_nmf(V, rank, options);
            ...
            [w_sol, infos_sol] = anls_nmf(V, rank, options);
            f_opt = nmf_cost(V, w_sol.W, w_sol.H, zeros(F, N));
        end
    ...
    if nmf_mod_mu_flag
        ...
        [w_mod_nmf_mu, infos_mod_nmf_mu] = fro_mu_nmf(V, rank, options);
    ...
    if nmf_acc_mu_flag
        ...
        [w_nmf_acc_mu, infos_nmf_acc_mu] = fro_mu_nmf(V, rank, options);
    ...
    if nmf_direct_pgd_flag
        ...
        [w_nmf_direct_pgd, infos_nmf_direct_pgd] = pgd_nmf(V, rank, options);
    ...
    if anls_asgroup_flag
        ...
        [w_anls_asgroup, infos_anls_asgroup] = anls_nmf(V, rank, options);
