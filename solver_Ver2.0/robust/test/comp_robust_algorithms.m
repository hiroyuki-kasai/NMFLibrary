function comp_robust_algorithms()
...
% Created by H.Kasai on May 21, 2019
    ...
    [N, F, K, Vo, V, Ro] = load_dataset(d, '../../../data', rho);        
    fprintf('done\n');
    dim = N * F;
    ...
    if rnmf_flag
        ...
        [x, info] = robust_mu_nmf(V, K, options);
    ...
    if ronmf_flag
        ...
        [x, info] = robust_online_mu_nmf(V, K, options);
